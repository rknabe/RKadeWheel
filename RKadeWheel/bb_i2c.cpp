...
#define I2C_SDA_LOW \
  { \
    pinModeFast(I2C_PIN_SDA, OUTPUT); \
    __builtin_avr_delay_cycles(I2C_DELAY); \
  }
#define I2C_SDA_HIGH \
  { \
    pinModeFast(I2C_PIN_SDA, INPUT); \
    __builtin_avr_delay_cycles(I2C_DELAY); \
  }
#define I2C_SCL_LOW \
  { \
    pinModeFast(I2C_PIN_SCL, OUTPUT); \
    __builtin_avr_delay_cycles(I2C_DELAY); \
  }
#define I2C_SCL_HIGH \
  { \
    pinModeFast(I2C_PIN_SCL, INPUT); \
    __builtin_avr_delay_cycles(I2C_DELAY); \
  }
